...
class ChatBot(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith('tell me about '):
            ...
            try:
                ...
                if data.get('success') and data.get('story'):
                    # print(json.JSONDecodeError.pretty_generate(data))
                    pprint(data)
        ...
        if "nft" in message.content.lower():  # changed from message.content.contains to "in" for checking the substring
            if ens_domain in self.api_responses:  # Check if the data is in cache
...
# class ChatBot(discord.Client):
#     # ... [rest of your code in ChatBot remains unchanged]
...
#         # ... [rest of your on_message code remains unchanged]
